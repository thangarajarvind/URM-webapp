...
import { CANDIDATES_LIST } from '../academia/Contsants/academia';
       ...
       <div className="main-content">
                <div className="filter_card1">
                    ...
                    <div className="filter_container">
                        ...
                        <button type="button" className="searchbtn" onClick={deicandidatesearch} style={{ float: 'right' }}>Search</button>
                    </div>
                </div>
